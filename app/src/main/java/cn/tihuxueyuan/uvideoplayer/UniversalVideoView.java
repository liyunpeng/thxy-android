package cn.tihuxueyuan.uvideoplayer;
...
//            }
            ...
            if (seekToPosition > 3000 && seekToPosition < mMediaPlayer.getDuration() - 1000) {
                seekTo(seekToPosition - 1000);
            } else {
                mSeekWhenPrepared = 0;
            }
    ...
    private MediaPlayer.OnInfoListener mInfoListener =
            new MediaPlayer.OnInfoListener() {
                ...
                private boolean mVideo_rendering_start;
                ...
                public boolean onInfo(MediaPlayer mp, int what, int extra) {
                    ...
                    switch (what) {
                        case MediaPlayer.MEDIA_INFO_BUFFERING_START:
                            ...
                            if (mMediaController != null && mVideo_rendering_start) {
                                mMediaController.showLoading();
                            }
                            handled = true;
                            break;
                        ...
                        case MediaPlayer.MEDIA_INFO_VIDEO_RENDERING_START:
                            handled = true;
                            mVideo_rendering_start = true;
                            if (mMediaController != null) {
                                mMediaController.updatePlay();
                                mMediaController.hideLoading();
                            }
                    }
...
//        }
        ...
        if (isInPlaybackState() && mPreparedBeforeStart) {
    ...
    @Override
    public void setPrepared(MediaPlayer.OnPreparedListener onPreparedListener) {
