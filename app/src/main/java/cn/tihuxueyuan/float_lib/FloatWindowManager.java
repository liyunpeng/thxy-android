package cn.tihuxueyuan.float_lib;
...
import cn.tihuxueyuan.float_lib.util.Constants_LM;
import cn.tihuxueyuan.float_lib.util.SpUtil;
import cn.tihuxueyuan.float_lib.view.FloatLayout;
...
//        if (Build.VERSION.SDK_INT >= 24) { /*android7.0不能用TYPE_TOAST*/
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) { /*android7.0不能用TYPE_TOAST*/
