package cn.tihuxueyuan.setting;

import static cn.tihuxueyuan.utils.Constant.mWM;
...
public class CToast {
    ...
    public static CToast makeText(Context context, CharSequence text, int duration) {
        ...
        mLayout.setBackgroundResource(R.drawable.tab_background);
    ...
    public void show() {
//        mHandler.post(mShow);
        mHandler.postDelayed(mShow, 1000);
...
//            mWM = (WindowManager) cc.getSystemService(Context.WINDOW_SERVICE);
